...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyDummy-key-for-development"),
    ...
    storageBucket: ("TURBOPACK compile-time value", "will-management.appspot.com"),
    messagingSenderId: ("TURBOPACK compile-time value", "107284572852002376363"),
    appId: ("TURBOPACK compile-time value", "1:107284572852002376363:web:dummy")
};
...
const AUTH_MODE = ("TURBOPACK compile-time value", "development") || "test";
...
function AuthProvider({ children }) {
    ...
    const [testModeLoggedIn, setTestModeLoggedIn] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // In test mode, don't use Firebase auth
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTestMode"])()) {
            setIsLoading(false);
            return;
        }
        // Subscribe to Firebase auth state changes
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onAuthChange"])((firebaseUser)=>{
    ...
    const login = async (email, password)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"])(email, password);
        } catch (err) {
    ...
    const register = async (email, password)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUp"])(email, password);
        } catch (err) {
            const errorMessage = getFirebaseErrorMessage(err.code);
            setError(errorMessage);
            throw new Error(errorMessage);
    ...
    const logoutUser = async ()=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logout"])();
        } catch (err) {
    ...
    const isAuthenticated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTestMode"])() ? testModeLoggedIn : !!user;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        value: {
            user,
            isLoading,
            isAuthenticated,
            authMode: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AUTH_MODE"],
            isTestMode: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTestMode"])(),
            login,
            register,
            logoutUser,
            error,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d304ae0._.js.map